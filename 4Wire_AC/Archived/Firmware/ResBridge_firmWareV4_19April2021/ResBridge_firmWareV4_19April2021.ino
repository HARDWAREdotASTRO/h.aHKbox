...
float freq_m = 10; // Frequency of Modulation (Hz), [1, 160]
float rms_sum, tim;
int i = 0;
int samps = (320 / freq_m) + 1; //Number of samples per frame of period
...
void loop() {
  ...
  Sin(freq_m, tim);
  rms_sum = 0;
  voltRead[i%(samps-1)] = ((nau.read() / 8388608.0) * 2.5) - 1.6;
